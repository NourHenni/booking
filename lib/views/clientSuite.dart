import 'package:booking_project/Widgets/clientBar.dart';
...
class clientSuite extends StatefulWidget {
  const clientSuite({super.key});

  @override
  State<clientSuite> createState() => _clientSuite();
}

class _clientSuite extends State<clientSuite> {
   var cat = [
    'Hamamamt',
    'sousse',
    'Jerba',
