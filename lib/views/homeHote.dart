import 'package:booking_project/Widgets/userbar.dart';
...
class HoteProfile extends StatefulWidget {
  const HoteProfile({super.key});

  @override
  State<HoteProfile> createState() => _HoteProfile();
}

class _HoteProfile extends State<HoteProfile> {
  var cat = [
    'Hamamamt',
    'sousse',
    'Jerba',
